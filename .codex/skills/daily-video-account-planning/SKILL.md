...
description: Plan, draft, publish, and archive lead-generation content for the Guangzhou Mingge Finance & Tax WeChat Video Account. Use when users collect competitor copy, request topic options, confirm a topic, request copywriting, report publication, or request archive.
---

# 视频号内容工作流入口

账号以电商合规获客为主，服务电商企业老板、个体户、跨境经营者、中小企业老板和创业者。内容必须落到真实经营场景，能自然承接合规咨询、代理记账、主体规划或风险排查；不为播放量偏离获客目标。
...
| 说明内容已发布，或要求归档 | [发布与归档流程](references/publish-and-archive-workflow.md) + `财税视频号内容库/00-首页与维护规则/历史内容归档规范.md` | 预览或执行归档与回流 |
